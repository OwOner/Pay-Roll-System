...
var service_1 = require("./src/lib/payroll/service");
var engine_1 = require("./src/lib/payroll/engine");
var dotenv = require("dotenv");
dotenv.config({ path: ".env.local" });
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var employeeId, start, end, freq, context, result, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    employeeId = "1e55e8ce-f087-4fa5-a74e-ebcbccacc3d5";
                    start = "2026-07-26";
                    end = "2026-09-05";
                    freq = "Weekly";
                    console.log("Loading context...");
                    return [4 /*yield*/, (0, service_1.loadPayrollContext)(employeeId, start, end, freq)];
                case 1:
                    context = _a.sent();
